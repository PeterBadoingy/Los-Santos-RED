...
namespace LSR.Vehicles
{
    public class Anchor
    {
        ...
        private static readonly Dictionary<string, BoatAnchorConfig> AnchorConfigs = new Dictionary<string, BoatAnchorConfig>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            // Submersibles - commented out as they typically don't use anchors + _IS_THIS_MODEL_A_JETSKI ??? | Old names: _IS_THIS_MODEL_A_SUBMERSIBLE | _IS_THIS_MODEL_AN_EMERGENCY_BOAT
